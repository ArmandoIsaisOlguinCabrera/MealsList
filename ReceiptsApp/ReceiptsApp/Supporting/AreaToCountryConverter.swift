...
public class AreaToCountryConverter {
    private let areaToCountry: [String: String] = [
        "Afghan": "Afghanistan",
        "Albanian": "Albania",
        "Algerian": "Algeria",
    ...
    public func areaToCountry(area: String) -> String? {
        return areaToCountry[area]
    }
}
